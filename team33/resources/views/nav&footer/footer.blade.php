    ...
    <div id="footer_flex">
        <div>
            ...
            <blockquote>
                ...
                <br>
                <a href="{{('product')}}" class="footer_txt">Product Page</a>
                <br>
        ...
        <div>
            ...
            <a href="https://twitter.com/?lang=en" target="_blank" class="colour">
                <img src="{{asset('images/twitter.png')}}" class="footer_images" />
            </a>

            <a href="https://github.com/" target="_blank" class="colour">
                <img src="{{asset('images/github-sign.png')}}" class="footer_images" />
            </a>

            <a href="https://uk.linkedin.com/" target="_blank" class="colour">
                <img src="{{asset('images/linkedin.png')}}" class="footer_images" />
            </a>

            <a href="https://en-gb.facebook.com/" target="_blank" class="colour">
                <img src="{{asset('images/facebook.png')}}" class="footer_images" />
            </a>

            <a href="https://www.instagram.com/" target="_blank" class="colour">
                <img src="{{asset('images/instagram.png')}}" class="footer_images" />
            </a>
        </div>
    </div>

    <p class="footer_line1"><a href="" class="footer_txt">Gadget Galaxy</a>
        &copy; 2023</p>
</footer>